...
void updateLocation() {
    ...
    if (canupdatelocation)
    {
        ...
        deltaAngle = ((wheelATicks - wheelATicksPrev) * distancePerTick + (wheelBTicks - wheelBTicksPrev) * distancePerTick) / (2 * pivotDiam); // alles in mm; hoek in radialen
...
void loop()
{
    ...
    /*double targetX = 4;
    double targetY = 3;
    while (calculateDistance(targetX, targetY) > 0.1) {
